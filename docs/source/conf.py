...
# causallift documentation build
...
from causallift import __version__ as release

# -- Project information -----------------------------------------------------

project = "causallift"
copyright = "2019, Yusuke Minami"
...
htmlhelp_basename = "causalliftdoc"
...
latex_documents = [
    (master_doc, "causallift.tex", "causallift Documentation", "QuantumBlack", "manual")
]
...
man_pages = [(master_doc, "causallift", "causallift Documentation", [author], 1)]
